# Sayansi: Kitabu cha Mwanafunzi, Darasa la Nne — ADT Bundle Reference
...
**Sayansi: Kitabu cha Mwanafunzi, Darasa la Nne** — Hiki ni kitabu cha Sayansi cha mwanafunzi wa Darasa la Nne kilichoandaliwa na Taasisi ya Elimu Tanzania kwa mtaala wa elimu ya msingi wa Tanzania, na kimeandikwa kwa Kiswahili. Kinafunika mada za afya na magonjwa, maada, uunguaji wa vitu, nishati, pamoja na usimbaji katika kompyuta, hivyo kinalenga wanafunzi wa kiwango cha shule ya msingi ya kati. Kitabu kinatumia mbinu shirikishi na za vitendo kama majaribio, kazi za kufanya, michoro na mazoezi ili kujenga uelewa wa kisayansi, kufikiri kimantiki, na matumizi ya maarifa katika maisha ya kila siku.
...
```
SAYANSI-DARASA-LA-IV-KITABU-CHA-MWANAFUNZI/
├── adt/                              # THE WEB APP
...
├── SAYANSI-DARASA-LA-IV-KITABU-CHA-MWANAFUNZI.db                    # SQLite database (pipeline state)
├── SAYANSI-DARASA-LA-IV-KITABU-CHA-MWANAFUNZI.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg001_im001": "Cheti cha ithibati cha kitabu cha Sayansi cha mwanafunzi wa Darasa la Nne kutoka Wizara ya Elimu, Sayansi na Teknolojia. Kinaonyesha jina la kitabu, Taasisi ya Elimu Tanzania, tarehe ya idhini, na saini ya kamishna wa elimu.",
  "gl001": "afya",
  "gl001_def": "Hali ya mwili na akili kuwa vizuri na bila ugonjwa.",
  "qz001_que": "Mlo kamili ni nini?",
  "qz001_o0": "1) Mlo wa matunda tu",
  "qz001_o0_exp": "❌ Si sahihi. Matunda ni muhimu, lakini mlo kamili huwa na makundi yote makuu ya vyakula."
}
```
...
```json
{
  "afya": {
    "word": "afya",
    "definition": "Hali ya mwili na akili kuwa vizuri na bila ugonjwa.",
    "variations": ["afya bora"],
    "emoji": "🩺💪"
  }
}
```
...
```json
{
  "title": "Sayansi: Kitabu cha Mwanafunzi, Darasa la Nne",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "sw-TZ"
...
<section role="activity" data-section-type="activity_quiz" data-id="qz001"
    ...
    <p data-id="qz001_que">Mlo kamili ni nini?</p>

    <label data-activity-item="qz001_o0"
           data-explanation="❌ Si sahihi. Matunda ni muhimu, lakini mlo kamili huwa na makundi yote makuu ya vyakula." data-explanation-id="qz001_o0_exp">
        <input type="radio" name="qz001" value="qz001_o0" class="sr-only" />
        <span data-id="qz001_o0">1) Mlo wa matunda tu</span>
    </label>
    <!-- more options... -->
</section>
...
| Original PDF | `SAYANSI-DARASA-LA-IV-KITABU-CHA-MWANAFUNZI.pdf` |
| Pipeline database | `SAYANSI-DARASA-LA-IV-KITABU-CHA-MWANAFUNZI.db` (SQLite) |
